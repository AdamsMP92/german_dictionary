...
words = {
    ...
    "the draw": "das Unentschieden",
    "the point": "der Punkt",
    "the goal": "das Tor",
    "the field": "das Spielfeld",
    "the stadium": "das Stadion",
    "the hall": "die Halle",
    "the gym": "das Fitnessstudio",
    "the training": "das Training",
    "the exercise": "die Übung",
    "the warm-up": "das Aufwärmen",
    "the ball": "der Ball",
    "the racket": "der Schläger",
    "the net": "das Netz",
    "the helmet": "der Helm",
    "the shoe": "der Schuh",
    "the jersey": "das Trikot",
    "the medal": "die Medaille",
    "the trophy": "der Pokal",
    ...
    "the cycling": "das Radfahren",
    "the ski": "der Ski",
    "the snowboard": "das Snowboard",
    "the fitness": "die Fitness",
...
df.to_csv("dict_Nomen_Sport.csv")
